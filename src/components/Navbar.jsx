...
function Navbar() {
  return (
    <nav className="grid grid-cols-[auto_auto] sm:grid-cols-[auto_1fr_auto_auto] items-center gap-6 px-6 sm:px-10 bg-greyDark py-5 sm:py-0 sm:h-navbar-height justify-between z-[200]">
      <Link to="/">
        <img
          src="/images/logo.svg"
      ...
      <div className="row-start-2 sm:row-start-auto col-span-2 sm:col-span-1 flex space-x-4 text-[67%] sm:text-[80%] xl:text-[100%]">
        <Button
          to=""
          as={Link}
          variant={1}
